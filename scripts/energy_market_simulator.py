...
class EnergyMarketSimulator:
    def __init__(self, start_date, end_date, battery):
        self.start_date = start_date
        self.end_date = end_date
        self.battery = battery

    def calculate_pnl(self, schedule_df, actual_prices):
        pnl = 0
        for i in range(48):
    ...
    def process_daily_schedule(self, schedule_df):
    ...
    def run_daily_operation(self, prices, actual_prices):
    ...
    def simulate(self):
        ...
        for current_date in tqdm(
            ...
            current_date = self.start_date + datetime.timedelta(days=current_date)
