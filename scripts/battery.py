class Battery:
    ...
    def charge(self, mwh, duration_hours=0.5):
    ...
    def discharge(self, mwh, duration_hours=0.5):
    ...
    def update_soh(self, energy_cycled_mwh, dod):
        """
    ...
    def calculate_degradation_rate(self, energy_cycled_mwh, dod):
        """
